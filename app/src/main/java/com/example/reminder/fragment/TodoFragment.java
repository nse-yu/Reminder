...
public class TodoFragment extends Fragment {
    ...
    public TodoFragment(MemoAdapter memoAdapter) {
        this.memoAdapter = memoAdapter;
        this.memoAdapter.setLocation(LocationCodes.TODO);
    }
    ...
    public void onResume() {
        ...
        MainActivity.tabPosition = LocationCodes.TODO.code;
        memoAdapter.setLocation(LocationCodes.TODO);
        memoAdapter.setFilteredMemos(
                memoAdapter.getMemos().stream()
                        .filter(memo -> memo.getLocation() == LocationCodes.TODO.code)
